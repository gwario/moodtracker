...
package at.ameise.moodtracker.backend;
...
public class ApiConstants {
    ...
    public static final String ANDROID_CLIENT_ID = "1008624441817-pfdk2u7462bgnckai1p7u395tsnegl7n.apps.googleusercontent.com";

    /** Web client ID from Google Cloud console. */
    public static final String WEB_CLIENT_ID = "1008624441817-c2fcrutro43qsqcrkn7j91p744iaoofu.apps.googleusercontent.com";

    /** Audience ID used to limit access to some client to the API. */
    public static final String AUDIENCE_ID = WEB_CLIENT_ID;

    /** API package name. */
    public static final String API_OWNER = "moodtracker.ameise.at";
