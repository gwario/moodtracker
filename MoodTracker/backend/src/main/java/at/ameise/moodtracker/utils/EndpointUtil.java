...
public final class EndpointUtil {
     ...
     * @throws com.google.api.server.spi.response.UnauthorizedException when the user object does
     * not represent an admin.

    public static void throwIfNotAdmin(final User user) throws UnauthorizedException {
     ...
     * not represent an admin.
     */
    public static void throwIfNotAuthenticated(final User user) throws UnauthorizedException {
